...
def get_features(dataset, dataset_double, save_dir, labeling, onto_features, onto_filename):
    (ids_train, X_train, y_train, train_dict, train), (ids_test, X_test, y_test, test_dict, test) = get_XY(dataset, dataset_double, test_size=0.3, labeling=labeling, onto_features=onto_features, fname_onto = onto_filename)
...
if __name__== "__main__":
    ...
    parser.add_argument('-dataset', default='../../../Data/work/DeepMutationsData/data/triple_fitness.tsv', type=str, help="path to dataset")
    parser.add_argument('-dataset_double', default='../../../Data/work/DeepMutationsData/data/double_fitness.tsv', type=str, help="path to dataset")
    ...
    parser.add_argument('-index_k', default=0, type=int, help="index of whereich eval_k to use, need serious restructuring to be able to do everything!")
    parser.add_argument('-onto_filename', default='../../../Data/work/DeepMutationsData/data/goslim_yeast.obo', type=str, help="ontology features filename")
    ...
    models = ["RF", "lambda"] #["MLP", "RF",  "SGD", "Polynomial", "Gaussian", "Linear", "Ridge", "lambda", "SVR"]#, "NN", 'w12_baseline', 'w13_baseline', 'w23_baseline', 'combo_baseline', "lambda"] # "SVR", "MLP", "RF",  "SGD", "Polynomial", "Polynomial_Bagging",
    ...
    for model in models:
        ...
        pr_lines_per_featurelist = defaultdict(list)
        ...
        for i in args.train_k:
            ...
            if os.path.exists(os.path.join(save_dir, 'model'+str(i)+'.pkl')):
                ...
                train_set, test_set = get_features(args.dataset, args.dataset_double, save_dir, labeling, args.onto_features, args.onto_filename)
